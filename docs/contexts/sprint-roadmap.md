...
- **Day 38**: Upload API endpoint `POST /api/orgs/[orgSlug]/documents` — creates document + presigned URL, quota/billing/feature gates (429/402/403), analytics event tracking, 9 unit tests
